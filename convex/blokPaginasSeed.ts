...
// ── Kinderloos-variant (ongewenst kinderloos) ──────────────────────────
// Zelfde structuur en aanbod als de verlies-pagina, teksten toegespitst op
// een kinderwens die niet uitkwam. Toon: zie convex/nietAlleenKinderloosContent.ts.
export const kinderloosBlocks = () => [
  { key: "header", type: "header", logo: IMG.logo, merk: "Talk To Benji", sub: "Zij aan Zij" },

  {
    key: "hero", type: "hero",
    eyebrow: "8 weken persoonlijke begeleiding bij ongewenste kinderloosheid",
    titel1: "Iedereen om je heen gaat verder.",
    titel2: "Jij draagt iets wat niemand ziet.",
    body: [
      { soort: "lead", tekst: "Je gaat naar je werk. Je feliciteert anderen. Je doet wat er moet gebeuren." },
      { soort: "lead", tekst: "Maar soms word je ineens weer teruggeslingerd naar het gemis." },
      { soort: "whisper", tekst: "Een zwangerschapsaankondiging. Een kinderstoel. Moederdag." },
      { soort: "lead", tekst: "Of gewoon: wakker worden en opnieuw beseffen dat het kind waar je naar verlangde er niet is gekomen." },
      { soort: "lead", tekst: "En misschien denk je dan:" },
...

  {
    key: "herkenning", type: "herkenning",
    eyebrow: "Misschien herken je dit",
    titel: "Je mist iets wat er nooit is geweest, en toch is het gemis echt.",
    lead: "Je functioneert prima. En toch voelt het soms alsof je leven gewoon doorgaat, terwijl jij ergens bent blijven staan. Misschien denk je weleens:",
    voices: [
      "Ik wil erover praten, maar ik wil mijn omgeving ook niet steeds belasten.",
      "Waarom doet een zwangerschapsaankondiging vandaag ineens weer zo veel pijn?",
      "Iedereen om me heen bouwt een gezin op. Waarom lukt mij dat niet?",
...

  {
    ...
    stack: [
      "Je hoeft niet te weten hoe je verder moet.",
      "Je hoeft niet te weten wanneer je er \"overheen\" zou moeten zijn.",
      "Je hoeft geen \"plek te geven\" aan een verlangen dat misschien nooit helemaal weggaat.",
    ],
    kicker: "Je mag gewoon iemand naast je hebben. **En dat is Zij aan Zij.**",
  },

  {
    ...
    naast: [
      "Voor de dagen waarop je vooral wilt praten.",
      "Voor de dagen waarop je niets weet te zeggen.",
      "Voor de momenten waarop je ineens terugvalt, bij een aankondiging of een goedbedoelde vraag.",
      "Voor de hoop en de teleurstellingen die je opnieuw wilt vertellen.",
      "Voor alles wat je liever niet zegt tegen iemand die je kent.",
    ],
    slot: "Je hoeft niet met een hulpvraag te komen. Je mag gewoon komen met hoe het vandaag is.",
  },
...

  {
    ...
    foto: IMG.ien,
    paras: [
      "Ik ga je niet vertellen hoe je moet rouwen om iets wat er nooit is geweest. Ik weet hoe eenzaam het kan zijn als iedereen om je heen een gezin opbouwt, terwijl jij een verlangen draagt dat niet uitkwam.",
      "Ik ken die kinderwens die niet uitkwam van dichtbij. En ik ken verlies ook in andere gedaantes: een bedrijf waar ik alles in had gelegd, en dieren die voor mij familie waren. Ik heb naast mensen gestaan die het zwaarste meemaakten wat er is.",
      "Daarom heb ik Zij aan Zij gemaakt. Geen methode die je moet volgen. Geen vinkjes die je moet zetten. Gewoon iemand die naast je blijft.",
    ],
  },

  {
    ...
    titel: "Gewoon iemand die bleef.",
    quotes: [
      { tekst: "Voor het eerst hoefde ik niet uit te leggen waarom het na al die tijd nog steeds pijn deed.", bron: "Voorbeeld, vervangen voor livegang" },
      { tekst: "Ik dacht dat ik vooral iemand nodig had die luisterde. Pas onderweg merkte ik hoeveel ik al die tijd alleen had gedragen.", bron: "Voorbeeld, vervangen voor livegang" },
      { tekst: "Geen adviezen, geen 'het komt vast nog wel'. Gewoon iemand die bleef. Dat was precies wat ik nodig had.", bron: "Voorbeeld, vervangen voor livegang" },
    ],
  },
...
export const seedZijAanZijKinderloos = internalMutation({
  args: {},
  handler: async (ctx) => {
    const slug = "zij-aan-zij-kinderloos";
    const blocksJson = JSON.stringify(kinderloosBlocks());
    const bestaand = await ctx.db
      .query("blokPaginas")
      .withIndex("by_slug", (q) => q.eq("slug", slug))
      .first();
    const data = {
      slug,
      naam: "Zij aan Zij — ongewenst kinderloos",
      pageTitle: "Zij aan Zij — 8 weken persoonlijke begeleiding bij ongewenste kinderloosheid",
      verliestype: "kinderloos",
      gepubliceerd: false, // concept: Ien leest na en publiceert in admin
      metaDescription:
        "Persoonlijke begeleiding bij ongewenste kinderloosheid. Acht weken lang iemand die naast je blijft, met Ien en Benji.",
      blocksJson,
      updatedAt: Date.now(),
    };
    if (bestaand) {
