...
const EH_TYPE_TEMPLATES: Record<string, { subject: string; bodyText: string; buttonText?: string; buttonUrl?: string; imageCaption?: string }> = {
  ...
  ...ehMailSet("kinderloos", {
    ...
    m3s: "Wat als je er elke dag even bij stil mocht staan?",
    m3: `Hi {voornaam},\n\nRouwen om wat er nooit kwam gaat in golven. Een aankondiging, een zwangere buik, een verjaardag die er niet is. Zonder waarschuwing.\n\nWat helpt, is er niet tegen vechten, maar er elke dag een beetje ruimte voor maken. Een paar minuten.\n\nDaarom bestaat Niet Alleen. 8 weken, om de dag een korte mail in je inbox. Voor het verdriet dat geen datum heeft, zonder dat je iets hoeft uit te leggen.\n\nJe leest het wanneer jij er klaar voor bent.\n\nVolgende week vertel ik je meer. Voor nu: weet dat het er is.`,
    m4s: `"Ik wist niet dat ik dit nodig had"`,
  ...
  ...ehMailSet("algemeen", {
    ...
    m5s: "Je hoeft dit niet alleen te doen",
    m5: `Hi {voornaam},\n\nDe afgelopen dagen vertelde ik je meer over Niet Alleen. Vandaag ook gewoon wat het kost.\n\nNiet Alleen kost eenmalig €49. Geen abonnement, geen automatische verlenging. Je koopt het één keer en hebt er 8 weken begeleiding voor.\n\nJe start wanneer jij er klaar voor bent.\n\nOm de dag een korte, zachte mail. Geen huiswerk, geen druk om snel beter te worden. Gewoon ruimte, en het gevoel: hier ben ik niet alleen.\n\nTwijfel je? Dan bewaar je deze mail en open je hem als de tijd er rijp voor is.\n\nIk ben blij dat je er bent.`,
  }),
};
...
export const DEFAULT_TEMPLATES = {
  ...
  renewal_jaar_1: {
    ...
    aanhef: "Hi {naam},",
    bodyText: `Het is bijna een half jaar geleden dat je met Talk To Benji bent begonnen. Ik hoop dat het je heeft geholpen, op welke manier dan ook.\n\nJe toegang loopt over ongeveer een maand af op {einddatum}. Als je nog een half jaar samen wil gaan, is dat van harte welkom.`,
    buttonText: "Nog een half jaar samen",
    buttonUrl: "https://www.talktobenji.com/betalen/6-maanden",
  },
  renewal_jaar_2: {
    subject: "Nog twee weken, wil je verder?",
    aanhef: "Hi {naam},",
    bodyText: `Nog twee weken, dan loopt je toegang tot Talk To Benji af op {einddatum}.\n\nAlles wat je hebt opgebouwd, je gesprekken, reflecties en memories, blijft bewaard zolang je account bestaat. Maar Benji zal na die datum niet meer voor je beschikbaar zijn.\n\nWil je nog een half jaar verder?`,
  ...
  renewal_jaar_3: {
    ...
    aanhef: "Hi {naam},",
    bodyText: `Vandaag is de laatste dag van je half jaar met Talk To Benji.\n\nIk ben blij dat je er was. Ik hoop dat het halfjaar je iets heeft gegeven, al was het maar het gevoel dat je er niet alleen voor stond.\n\nAls je nog een half jaar verder wilt, kun je dat hieronder regelen. Benji staat voor je klaar.\n\nWil je liever stoppen? Je kunt al je gegevens downloaden of je account verwijderen via Instellingen in je account.`,
    buttonText: "Nog een half jaar samen",
    buttonUrl: "https://www.talktobenji.com/betalen/6-maanden",
  },
  ...
  renewal_kwartaal_1: {
    ...
    buttonUrl: "https://www.talktobenji.com/betalen/3-maanden",
    upsellText: "Een half jaar voor €90",
    upsellUrl: "https://www.talktobenji.com/betalen/6-maanden",
  },
  renewal_kwartaal_2: {
  ...
  renewal_maand_1: {
    ...
    buttonUrl: "https://www.talktobenji.com/betalen/maand",
    upsellText: "3 maanden voor €50",
    upsellUrl: "https://www.talktobenji.com/betalen/3-maanden",
  },
  renewal_maand_2: {
  ...
  niet_alleen_welkom: {
    ...
    bodyText: `Fijn dat je er bent. De komende 8 weken lopen we samen met je mee, stap voor stap.\n\nOm de dag ontvang je een kleine vraag. Geen druk, geen goed of fout. Gewoon ruimte voor wat er in je leeft.`,
  },
  niet_alleen_dag: {
...
Benji`,
  ...
  niet_alleen_dag28: {
    ...
    bodyText: `Je 8 weken zijn bijna klaar. Wat je hebt geschreven, is van jou. Het verdwijnt niet zomaar.\n\nAan het eind sturen we je een overzicht van alles wat je hebt ingevuld, zodat je het kunt bewaren. Wil je daarna gewoon verdergaan? Dan kun je volledige toegang tot Benji nemen, zonder verplichting.`,
  },
  niet_alleen_dag30: {
    subject: "Je 8 weken zijn klaar, dit is voor jou",
    bodyText: `Je hebt het gedaan. 8 weken lang ben je er geweest voor jezelf. Dat is meer dan het klinkt.
...
Ik heb een klein boekje voor je gemaakt. Woorden die je omarmen: spreuken en gedichtjes om bij stil te staan op de momenten dat het zwaar is. Klik op het boekje om het te openen.`,
  ...
  // Vervangt op dag 3 de "Benji voorstellen"-mail voor wie de brief-link al gebruikte.
  // Bewerkbaar in de admin. De knop wordt automatisch een één-klik Benji-link (buttonUrl leeg laten).
  eh_brief_kom_terug: {
