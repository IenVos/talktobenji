...
const FAQ_ITEMS = [
  ...
  { category: "abonnement", order: 11, question: "Wat is de gratis proefperiode?", answer: "Met een gratis account zijn je eerste vijf gesprekken gratis, met volledige toegang tot alle functies. Je hoeft geen betaalgegevens in te voeren. Daarna kies je zelf of en hoe je verdergaat — je gegevens blijven altijd bewaard." },
