...
export const getBySlug = query({
  ...
  handler: async (ctx, args) => {
    ...
    return {
      ...
      ehPopupAan: page.ehPopupAan ?? false,
      ehPopupModus: page.ehPopupModus ?? null,
      ehPopupTekst: page.ehPopupTekst ?? null,
      ehPopupKnopTekst: page.ehPopupKnopTekst ?? null,
      ehPopupKnopUrl: page.ehPopupKnopUrl ?? null,
      ehPopupKnopKleur: page.ehPopupKnopKleur ?? null,
...
export const getForAdmin = query({
  ...
  handler: async (ctx, args) => {
    ...
    return {
      ...
      ehPopupAan: page.ehPopupAan ?? false,
      ehPopupModus: page.ehPopupModus ?? "",
      ehPopupTekst: page.ehPopupTekst ?? "",
      ehPopupKnopTekst: page.ehPopupKnopTekst ?? "",
      ehPopupKnopUrl: page.ehPopupKnopUrl ?? "",
      ehPopupKnopKleur: page.ehPopupKnopKleur ?? "",
...
export const save = mutation({
  args: {
    ...
    ehPopupModus: v.optional(v.string()),
  ...
  handler: async (ctx, args) => {
    ...
    const data = {
      ...
      ehPopupAan: args.ehPopupAan,
      ehPopupModus: args.ehPopupModus,
      ehPopupTekst: args.ehPopupTekst,
      ehPopupKnopTekst: args.ehPopupKnopTekst,
      ehPopupKnopUrl: args.ehPopupKnopUrl,
      ehPopupKnopKleur: args.ehPopupKnopKleur,
