...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    return await ctx.db.insert("checkoutProducts", {
      ...
      evenHouvastPopupKnopTekst: args.evenHouvastPopupKnopTekst,
      evenHouvastPopupKnopUrl: args.evenHouvastPopupKnopUrl,
      evenHouvastPopupKnopKleur: args.evenHouvastPopupKnopKleur,
