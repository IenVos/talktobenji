...
export function SiteFooter({ variant = "light" }: SiteFooterProps) {
  ...
  if (isDark) {
    return (
      <div className="w-full text-center px-4 py-3 space-y-1.5">
        <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-[10px] sm:text-xs text-primary-300">
          ...
          <Link href="/algemene-voorwaarden" className="hover:text-primary-100 transition-colors">Algemene voorwaarden</Link>
