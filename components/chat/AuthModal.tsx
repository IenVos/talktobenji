    ...
    >
      ...
      >
        ...
        <div className="flex gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">Account aanmaken / Inloggen</h3>
            <p className="text-xs text-gray-500">Maak een account of log in om je gesprekken te bewaren</p>
          </div>
        </div>
        <button
          type="button"
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 bg-[#e8eded] text-[#5a8a8a] hover:bg-[#d8e0e0] disabled:opacity-50"
        >
          {loading ? (
