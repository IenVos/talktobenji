...
const PRIVACY_DEFAULTS: Section[] = [
  ...
  { title: "Hoe lang bewaren we je gesprekken?", body: "Je gesprekken blijven beschikbaar zolang je ze nodig hebt. Je kunt zelf bepalen wanneer je ze wilt verwijderen.\n\nWanneer je een gesprek verwijdert, heb je twee opties:\n- Volledig verwijderen: dan is het weg, ook voor training\n- Anonimiseren: je gesprek wordt losgekoppeld van jou en kan worden gebruikt om Benji te verbeteren" },
  { title: "Benji en AI", body: "Benji gebruikt AI om te reageren op wat je schrijft. Dit betekent:\n- Je berichten worden verwerkt door een AI-model\n- De AI heeft geen toegang tot eerdere gesprekken van andere gebruikers\n- Elk gesprek staat op zichzelf\n\nWe werken continu aan het verbeteren van Benji's reacties." },
  ...
  { title: "Je rechten", body: "Je hebt het recht om:\n- Je gesprekken in te zien\n- Je gesprekken te verwijderen\n- Te weten wat we met je data doen (dat lees je hier)\n- Bezwaar te maken tegen verwerking" },
  { title: "Contact", body: "Vragen over je privacy? Neem contact op via contactmetien@talktobenji.com." },
];

const AV_DEFAULTS: Section[] = [
  { title: "Wat Benji is", body: "Benji is een AI-chatbot die een luisterend oor biedt voor mensen die te maken hebben met verlies of verdriet. Benji is er om te luisteren, niet om te oordelen." },
  { title: "Wat Benji niet is", body: "Benji is geen vervanging voor:\n- Professionele hulpverlening of therapie\n- Contact met vrienden, familie of naasten\n- Medisch of psychologisch advies\n\nBenji is bedoeld als aanvulling, een plek waar je terecht kunt wanneer je even wilt praten, zonder dat je iemand tot last bent." },
  { title: "Professionele hulp", body: "Benji herkent wanneer je mogelijk professionele hulp nodig hebt en zal je doorverwijzen naar 113. Of chat via 113.nl." },
  { title: "Je gesprekken", body: "Je gesprekken worden opgeslagen zodat je later verder kunt praten. We gebruiken geanonimiseerde data om Benji te verbeteren. Lees ons privacybeleid voor meer details over hoe we met je gegevens omgaan." },
  { title: "Geen garanties", body: "We doen ons best om Benji zo behulpzaam mogelijk te maken, maar:\n- Benji kan fouten maken of iets verkeerd begrijpen\n- Benji is niet altijd beschikbaar (bij technische storingen)\n- Reacties van Benji zijn geen professioneel advies" },
  ...
  { title: "Wijzigingen", body: "We kunnen deze voorwaarden aanpassen. Bij grote wijzigingen laten we dit weten op de website." },
