  ...
  return (
    ...
    >
      <style>{`
        ...
        .shot{ position:relative; flex:0 1 auto; max-height:88%; display:flex; justify-content:center; align-items:center; }
        ...
        .oefcover{ position:absolute; left:50%; top:78%; width:28%; aspect-ratio:1; transform:translate(-50%,-50%); background:#efeae4; border-radius:50%; }
        .oefcirkel{ position:absolute; left:50%; top:78%; width:15%; aspect-ratio:1; transform:translate(-50%,-50%) scale(.55); border-radius:50%; background:rgba(109,132,168,.45); box-shadow:0 0 14px 4px rgba(109,132,168,.16); animation:adem 12s ease-in-out infinite; }
