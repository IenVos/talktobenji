      ...
      <main className="flex-1 w-full max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8 text-gray-700 text-sm sm:text-base leading-relaxed">
        ...
        <div className="pt-8 mt-8 space-y-4">
          ...
          <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
            <span className="italic">P.S.</span> Je eerste vijf gesprekken zijn gratis, zonder tijdslimiet. Maak je een account aan, dan blijven ze bewaard zodat je later kunt teruglezen wat je hebt gedeeld. Daarna kies je zelf hoe je verdergaat.
          </p>
