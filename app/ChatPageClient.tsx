...
export function ChatPageClient({ topicFromUrl: topicFromUrlProp }: ChatPageClientProps) {
  ...
  // Topic from URL (?topic=...) – ontvangen als prop van server
  useEffect(() => {
    const topicFromUrl = (topicFromUrlProp ?? null) as TopicId | null;
