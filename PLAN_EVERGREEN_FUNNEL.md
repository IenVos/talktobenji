...
- **Andere voettekst voor de evergreen mails.** Het Benji-blok en de vaste "Niet Alleen voor jou"-link onderaan (nu in de reactivatiemail en de EH-mails) horen NIET in elke evergreen mail. Bij het bouwen van de evergreen (stap 3): de brug naar Niet Alleen alleen in de laatste mail van een blok, een rustoptie-link in de voettekst, en elke mail een kort "van Benji"-stukje, ondertekend "Ien en Benji". De evergreen mails krijgen dus hun eigen renderer/voettekst, los van de reactivatie- en EH-opmaak.
- **Aantal reactivatiemails.** Nu één mail. Advies: één houden. Wie hem krijgt stroomt de evergreen in en wordt daar verder genurcht, dus ze zijn niet "klaar" na één mail. Eventueel later één zachte herinnering aan wie niet klikte/activeerde (na circa 4 dagen), maar geen mini-funnel: over-mailen van een koude lijst kost afmeldingen.
